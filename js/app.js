...
window.onload = function () {
    ...
    <div id="row2" class="row ">
        <div id="cardRow" class="container-fluid col-xl-7 col-lg-7 col-md-12 col-sm-10 col-xs-12 my-5">
            <div><h3 class="py-5">Seleccione una carta:</h3><br></div>
        </div>
        <div id="infoRow" class="container-lg col-md-4 col-sm-12 col-xs-12 my-3"></div>
    </div>
</div>
`
    );
